...
- El siguiente identificador disponible para un spec es `004`; no se reutiliza `001`, que quedó reservado históricamente para el documento que originó el roadmap.
