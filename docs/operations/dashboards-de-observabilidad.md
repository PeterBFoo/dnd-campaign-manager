...
- Desde la retirada de `dnd-postgres-observability` el 2026-08-31 solo debe existir la fuente `deployment_topology="api-sidecar"`; una segunda fuente indica deriva o una recreación de rollback.
