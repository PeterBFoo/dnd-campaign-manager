...
| Campañas y catálogo de módulos | RF-010 a RF-019 | Parcial | Los specs 012 y 013 completan catálogo y asociación opcional; el spec 014 añade capítulos ordenados. Mapas, localizaciones y viajes siguen pendientes. |
...
| Capítulos y recursos | RF-060 a RF-066 | Parcial | El spec 014 implementa capítulos ordenados, autoría administrativa y lectura exclusiva del DM; mapas, localizaciones, NPC y validación editorial siguen pendientes. |
