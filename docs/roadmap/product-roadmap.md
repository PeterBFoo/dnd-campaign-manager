...
- Creado: 2026-08-19
- Última actualización funcional: 2026-09-02
...
| Campañas y catálogo de módulos | RF-010 a RF-019 | Parcial | Los specs 012 y 013 completan catálogo y asociación opcional; 014 añade capítulos ordenados, 015 mapas privados reutilizables y 016 localizaciones/POI. Los viajes siguen pendientes. |
...
| Capítulos y recursos | RF-060 a RF-066 | Parcial | Los specs 014, 015 y 016 implementan capítulos ordenados, mapas privados, localizaciones/POI, autoría administrativa y lectura exclusiva del DM; NPC y validación editorial siguen pendientes. |
...
La arquitectura Angular por capacidades del [spec 003](../specs/003-modularizacion-frontend/spec.md) está completada. La extracción modular de Access del [spec 002](../specs/002-modularizacion-access/spec.md) continúa en curso. El [spec 007](../specs/007-bitacora-campana/spec.md) completa el primer incremento de bitácora; la referencia opcional a NPC continúa pendiente. Los specs [012](../specs/012-libreria-modulos/spec.md), [013](../specs/013-asignacion-modulo-campana/spec.md), [014](../specs/014-capitulos-modulo/spec.md), [015](../specs/015-mapas-modulo/spec.md) y [016](../specs/016-localizaciones-puntos-interes/spec.md) implementan catálogo, asociación, capítulos, mapas y localizaciones/POI; el spec 017 conserva los viajes pendientes. Los specs [018](../specs/018-npc-modulo/spec.md), [019](../specs/019-visibilidad-npc-campana/spec.md) y [020](../specs/020-contenido-brujaluz/spec.md) siguen propuestos. Los specs 022 y 023 cubren el pipeline y ciclo de vida de las métricas PostgreSQL. Los specs 008 a 011 cubren misiones, Combat y eliminación de campañas. El siguiente identificador reservado para un spec nuevo es `024`.
...
Las filas 1 y 2 quedaron completadas por el [spec 004](../specs/004-creacion-campanas/spec.md) y la fila 4 por los specs 005 y 006. La fila 7 está completada parcialmente por el spec 007, sin referencias a NPC. Los specs [012](../specs/012-libreria-modulos/spec.md), [013](../specs/013-asignacion-modulo-campana/spec.md), [014](../specs/014-capitulos-modulo/spec.md), [015](../specs/015-mapas-modulo/spec.md) y [016](../specs/016-localizaciones-puntos-interes/spec.md) completan catálogo, asociación, capítulos, mapas y localizaciones; el 017 conserva los viajes pendientes de la fila 3. Los specs 018 a 020 concretan Library y la validación editorial. Los specs 022 y 023 cubren la observabilidad PostgreSQL. Los specs 008 a 011 cubren misiones, Combat y eliminación de campañas. El siguiente identificador disponible es `024`; no se crean de antemano specs vacíos para las demás filas.
...
13. **Implementado por el spec 014.** Los capítulos son una biblioteca completa para el DM, sin progreso, capítulo actual ni desbloqueo; el recorrido web y API verifica el módulo vigente de la campaña en cada lectura.
