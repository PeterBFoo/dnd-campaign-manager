...
| Campañas y catálogo de módulos | RF-010 a RF-019 | Parcial | Los specs 012 y 013 completan catálogo y asociación opcional; 014 añade capítulos ordenados y 015 mapas privados reutilizables. Localizaciones y viajes siguen pendientes. |
...
| Capítulos y recursos | RF-060 a RF-066 | Parcial | Los specs 014 y 015 implementan capítulos ordenados, mapas privados, autoría administrativa y lectura exclusiva del DM; localizaciones, NPC y validación editorial siguen pendientes. |
...
Las filas 1 y 2 quedaron completadas por el [spec 004](../specs/004-creacion-campanas/spec.md) y la fila 4 por los specs 005 y 006. La fila 7 está completada parcialmente por el spec 007, sin referencias a NPC. Los specs [012](../specs/012-libreria-modulos/spec.md), [013](../specs/013-asignacion-modulo-campana/spec.md), [014](../specs/014-capitulos-modulo/spec.md) y [015](../specs/015-mapas-modulo/spec.md) completan catálogo, asociación, capítulos y mapas; 016 y 017 conservan las capacidades restantes de la fila 3. Los specs 018 a 020 concretan Library y la validación editorial. Los specs 022 y 023 cubren la observabilidad PostgreSQL. Los specs 008 a 011 cubren misiones, Combat y eliminación de campañas. El siguiente identificador disponible es `024`; no se crean de antemano specs vacíos para las demás filas.
