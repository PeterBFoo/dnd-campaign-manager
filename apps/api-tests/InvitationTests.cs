...
public sealed class InvitationTests
{
    ...
    public void Invitation_cannot_be_accepted_at_the_expiration_instant()
    {
        ...
        var result = issued.Invitation.Accept(issued.Token, AcceptorId, IssuedAt.AddDays(7));
    ...
    public void Invitation_token_is_valid_only_once()
    {
        ...
        var firstAttempt = issued.Invitation.Accept(issued.Token, AcceptorId, IssuedAt.AddHours(1));
        var secondAttempt = issued.Invitation.Accept(issued.Token, AcceptorId, IssuedAt.AddHours(2));
        ...
        Assert.Equal(AcceptorId, issued.Invitation.AcceptedByUserId);
    ...
    public void Invalid_token_does_not_change_the_invitation()
    {
        ...
        var result = issued.Invitation.Accept("a-different-token", AcceptorId, IssuedAt.AddHours(1));
    ...
    public void Revoked_invitation_cannot_be_accepted()
    {
        ...
        var result = issued.Invitation.Accept(issued.Token, AcceptorId, IssuedAt.AddHours(2));
